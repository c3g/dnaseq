process BWA_MEM {
    ...
    def readgroup = [
        ...
        meta.sample                  ? "SM:${meta.sample}"                  : null,
        meta.library                 ? "LB:${meta.library}"                 : null,
        params.sequencing_center     ? "PU:${params.sequencing_center}"     : null,
        params.sequencing_technology ? "PL:${params.sequencing_technology}" : null
    ].minus(null)
    """
