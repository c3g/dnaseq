process FASTP {
    ...
    if (meta.single_end) {
        ...
        def adapter_args = meta.adapter1 ? "--adapter_sequence ${meta.adapter1}" : ''
        """
        ...
        def adapter1_args = meta.adapter1 ? "--adapter_sequence ${meta.adapter1}" : ''
        def adapter2_args = meta.adapter2 ? "--adapter_sequence_r2 ${meta.adapter2}" : ''
        """
